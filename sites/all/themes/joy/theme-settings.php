...
/**
 * @file
 * Theme setting callbacks for the joy theme.
 */
 ...
 *   The form state.
 */
function joy_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['joy_width'] = array(
    '#type' => 'radios',
    ...
    '#default_value' => theme_get_setting('joy_width'),
